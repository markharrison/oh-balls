...
export class SceneSplash extends SceneBase {
  ...
  async insertControls() {
    ...
    this.canvasUIHandler.addText('Version 0.005 - 22 Nov 2025', 640, 430, {
      fontSize: 24,
      align: 'center',
    });

    let menuItems = [{ label: 'Enter', callback: () => this.doEnter() }];
  ...
  async doEnter() {
    ...
    setTimeout(() => {
      ...
      this.canvasUIHandler.addText('Loading ....', 640, 500, { fontSize: 24, align: 'center' });
    }, 200);
